...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _app_provider = __webpack_require__(160);

	var _app_provider2 = _interopRequireDefault(_app_provider);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

	_reactDom2['default'].render(_react2['default'].createElement(_app_provider2['default'], null), document.querySelector('#container'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _chess_reducer = __webpack_require__(213);

	var _chess_reducer2 = _interopRequireDefault(_chess_reducer);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _turn = __webpack_require__(209);

	var _turn2 = _interopRequireDefault(_turn);

	var _captures = __webpack_require__(211);
	    ...
	    value: function () {
	      function render() {
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(_turn2['default'], null),
	          _react2['default'].createElement(_captures2['default'], null)
	        );
	      }
	  ...
	  function mapDispatchToProps(dispatch) {
	    return {
	      onBoardClick: function () {
	        function onBoardClick(space) {
	          dispatch((0, _actions.boardClick)(space));
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var BoardComponent = function (_Component) {
	  ...
	  function BoardComponent() {
	    ...
	    return _possibleConstructorReturn(this, (BoardComponent.__proto__ || Object.getPrototypeOf(BoardComponent)).apply(this, arguments));
	  }
	  ...
	  _createClass(BoardComponent, [{
	    ...
	    get: function () {
	      function get() {
	        return this.board.selectedSpace;
	      }
	    ...
	    get: function () {
	      function get() {
	        return this.selectedSpace.piece;
	      }
	    ...
	    get: function () {
	      function get() {
	        return this.props.chess.availableSpaces;
	      }
	      ...
	      function get() {
	        ...
	        return this.spaces.map(function (space) {
	          return _react2['default'].createElement(_space2['default'], {
	            space: space,
	            key: space.index,
	            selected: _this2.selectedSpace === space,
	            available: _this2.board.availableSpaces.includes(space),
	            handleClick: _this2.props.onBoardClick });
	        });
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SpaceComponent = function (_Component) {
	  _inherits(SpaceComponent, _Component);

	  function SpaceComponent() {
	    _classCallCheck(this, SpaceComponent);

	    return _possibleConstructorReturn(this, (SpaceComponent.__proto__ || Object.getPrototypeOf(SpaceComponent)).apply(this, arguments));
	  }
	      ...
	      function render() {
	        ...
	        return _react2['default'].createElement(
	          'div',
	          {
	            ...
	            onClick: function () {
	              function onClick() {
	                _this2.props.handleClick(_this2.space);
	              }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PieceComponent = function (_Component) {
	  _inherits(PieceComponent, _Component);

	  function PieceComponent() {
	    _classCallCheck(this, PieceComponent);

	    return _possibleConstructorReturn(this, (PieceComponent.__proto__ || Object.getPrototypeOf(PieceComponent)).apply(this, arguments));
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#container #board {\n\theight: 450px;\n\twidth: 450px;\n\tfloat: left;\n}\n\n#container #captures {\n\tborder: 1px solid black;\n\theight: 450px;\n\twidth: 200px;\n\tfloat: left;\n}\n\n#container .space {\n\theight: 50px;\n\twidth: 50px;\n\tborder: 1px solid black;\n\tfloat: left;\n\tposition: relative;\n}\n\n#container .piece {\n\tfont-size: 35px;\n\theight: 50px;\n\twidth: 50px;\n\ttext-align: center;\n}\n\n#container .index {\n\tfont-size: 10px;\n\tposition: absolute;\n}\n\n#container .white {\n\tcolor: white;\n\ttext-shadow:\n    -1px -1px 0 #000,\n    1px -1px 0 #000,\n    -1px 1px 0 #000,\n    1px 1px 0 #000;\n}\n\n#container .black {\n\tcolor: black;\n}\n\n#container .dark {\n\tbackground-color : #996d54;\n}\n\n#container .light {\n\tbackground-color : #F1D4B2;\n}\n\n#container .selected {\n\tbackground-color : red;\n}\n\n#container .available {\n\tbackground-color: #9ddbea;\n}\n", ""]);
...
/***/ (function(module, exports) {
	...
	var boardClick = exports.boardClick = function () {
	  function boardClick(space) {
	    return {
	      type: 'BOARD_CLICK',
	      space: space
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _turn = __webpack_require__(210);
	...
	exports['default'] = (0, _reactRedux.connect)(mapStateToProps)(_turn2['default']);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TurnComponent = function (_Component) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _captures = __webpack_require__(212);
	...
	exports['default'] = (0, _reactRedux.connect)(mapStateToProps)(_captures2['default']);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CapturesComponent = function (_Component) {
	  _inherits(CapturesComponent, _Component);

	  function CapturesComponent() {
	    _classCallCheck(this, CapturesComponent);

	    return _possibleConstructorReturn(this, (CapturesComponent.__proto__ || Object.getPrototypeOf(CapturesComponent)).apply(this, arguments));
	  }

	  _createClass(CapturesComponent, [{
	    key: 'render',
	    value: function () {
	      function render() {
	        return _react2['default'].createElement(
	    ...
	    get: function () {
	      function get() {
	        return this.props.chess.captures;
	      }

	      return get;
	    }()
	  }, {
	    key: 'captureComponents',
	    get: function () {
	      function get() {
	        return this.captures.filter(function (piece) {
	          return !piece.isNull;
	        }).map(function (capture, index) {
	          capture.captured = true;
	          return _react2['default'].createElement(_piece2['default'], { piece: capture, key: index });
	        });
	      }
	  ...
	  return CapturesComponent;
	}(_react.Component);

	exports['default'] = CapturesComponent;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports['default'] = function () {
	  var chess = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new _chess2['default']();
	  var action = arguments[1];
	...
	var _chess = __webpack_require__(214);
...
/***/ (function(module, exports) {
	...
	var Chess = function () {
	  function Chess() {
	    var board = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Board();
	...
	var Board = function () {
	  function Board() {
	    var spaces = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : StartingSpaces();
	    ...
	    get: function () {
	      function get() {
	        ...
	        return this.spaces.filter(function (space) {
	          return _this.selectedPiece.validMove(_this.selectedSpace, space);
	        });
	      }
	...
	var Space = function () {
	  function Space(index) {
	    var piece = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new NullPiece();
	...
	var Rook = function (_Type2) {
	  ...
	  _createClass(Rook, [{
	    ...
	    value: function () {
	      function validMove(currentSpace, newSpace, color) {
	        var sameColumn = currentSpace.column === newSpace.column && currentSpace.row !== newSpace.row;
	        var sameRow = currentSpace.row === newSpace.row && currentSpace.column !== newSpace.column;
